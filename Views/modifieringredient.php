                            ...
                            <div class="card alert">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                         ...
                                         <form method="POST"  id="connexion" action="editingredient.php" > 
...
if (isset($_POST['modifier'])){
    $ingredient=new ingredient($_POST['id'],$_POST['barcode'],$_POST['quantity'],$_POST['category'],$_POST['type']);
    $ingredientc->modifieringredient($ingredient,$_POST['id_ini']);
